...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            setError(errorMessage.includes('Invalid login credentials') ? 'Invalid email or password. Please try again.' : errorMessage);
        } finally{
...
_s(LoginPage, "sqw75Mh1Rz7SGttB1wCnoCx3wOo=", false, function() {
    return [
