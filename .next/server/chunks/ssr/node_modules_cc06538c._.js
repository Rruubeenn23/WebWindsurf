...
function filterCookies(cookies, key) {
    const indexes = new Set(cookies.map((cookie)=>(0, import_cookie.parse)(cookie)).reduce((acc, cookie, i)=>{
        if (key in cookie) {
            acc.push(i);
        }
        return acc;
...
function isSecureEnvironment(headerHost) {
    ...
    if ([
        "localhost",
        "127.0.0.1"
    ].indexOf(host) > -1 || host.endsWith(".local")) {
        return false;
    }
    return true;
}
...
// src/supabase-browser.ts
function createBrowserSupabaseClient({ supabaseUrl, supabaseKey, options, cookieOptions: { name = "supabase-auth-token", domain, path = "/", sameSite = "lax", secure, maxAge = 1e3 * 60 * 60 * 24 * 365 } = {} }) {
...
;
function createServerSupabaseClient({ supabaseUrl, supabaseKey, getCookie, setCookie, getRequestHeader, options, cookieOptions: { name = "supabase-auth-token", domain, path = "/", sameSite = "lax", secure, maxAge = 1e3 * 60 * 60 * 24 * 365 } = {} }) {
...
function createBrowserSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://tyvdibofmodhzhngmoab.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR5dmRpYm9mbW9kaHpobmdtb2FiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcxMDIxMjEsImV4cCI6MjA3MjY3ODEyMX0.XKEbrhlHK6RQPlFy7N79tA7qDvCFY_S1KaCewyZbrsc"), options, cookieOptions } = {}) {
    var _a;
...
function createServerSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://tyvdibofmodhzhngmoab.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR5dmRpYm9mbW9kaHpobmdtb2FiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcxMDIxMjEsImV4cCI6MjA3MjY3ODEyMX0.XKEbrhlHK6RQPlFy7N79tA7qDvCFY_S1KaCewyZbrsc"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
    return (0, import_auth_helpers_shared.createServerSupabaseClient)({
        ...
        setCookie (name, value, options2) {
            var _a2;
            const newSetCookies = (0, import_auth_helpers_shared.filterCookies)((0, import_auth_helpers_shared.ensureArray)(((_a2 = context.res.getHeader("set-cookie")) == null ? void 0 : _a2.toString()) ?? []), name);
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://tyvdibofmodhzhngmoab.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR5dmRpYm9mbW9kaHpobmdtb2FiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcxMDIxMjEsImV4cCI6MjA3MjY3ODEyMX0.XKEbrhlHK6RQPlFy7N79tA7qDvCFY_S1KaCewyZbrsc"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createServerComponentSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://tyvdibofmodhzhngmoab.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR5dmRpYm9mbW9kaHpobmdtb2FiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcxMDIxMjEsImV4cCI6MjA3MjY3ODEyMX0.XKEbrhlHK6RQPlFy7N79tA7qDvCFY_S1KaCewyZbrsc"), headers, cookies, options, cookieOptions }) {
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
    return (0, import_auth_helpers_shared.createServerSupabaseClient)({
...
//# sourceMappingURL=node_modules_cc06538c._.js.map